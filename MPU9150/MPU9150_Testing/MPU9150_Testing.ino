...
int MPU9150_I2C_ADDRESS = ACCEL_GYRO_I2C_ADDRESS;

//Variables where our values can be stored
int data[9];

#define DEBUG_PIN_1 5
boolean debug1State = false;
...
*/
  ...
  data[6] = MPU9150_readSensor(MPU9150_ACCEL_XOUT_L,MPU9150_ACCEL_XOUT_H);
  data[7] = MPU9150_readSensor(MPU9150_ACCEL_YOUT_L,MPU9150_ACCEL_YOUT_H);
  data[8] = MPU9150_readSensor(MPU9150_ACCEL_ZOUT_L,MPU9150_ACCEL_ZOUT_H);
  /**/
  ...
  */
  ...
  /* Printing *
  serialMsg = String(data[0]);
  for(int i = 1; i < 9; i++)
  {
    serialMsg = serialMsg + "\t" + String(data[i]);
  }
...
void MPU9150_setupCompass(){
  MPU9150_I2C_ADDRESS = MAG_I2C_ADDRESS;      //change Adress to Compass

  MPU9150_writeSensor(0x0A, 0x00); //PowerDownMode
  MPU9150_writeSensor(0x0A, 0x0F); //SelfTest
  MPU9150_writeSensor(0x0A, 0x00); //PowerDownMode

  MPU9150_I2C_ADDRESS = ACCEL_GYRO_I2C_ADDRESS;      //change Adress to MPU
